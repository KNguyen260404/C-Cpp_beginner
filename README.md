...
<details>
<summary>🔧 <strong>Lỗi biên dịch</strong></summary>

```bash
# Lỗi: 'g++' is not recognized
# Giải pháp: Cài đặt MinGW hoặc GCC
...
<details>
<summary>📁 <strong>Lỗi không tìm thấy file</strong></summary>

```cpp
// Đảm bảo file nằm cùng thư mục với .cpp
// Hoặc sử dụng đường dẫn tuyệt đối
ifstream file("C:/full/path/to/file.txt");
```

</details>

<details>
<summary>🔢 <strong>Lỗi nhập liệu</strong></summary>
